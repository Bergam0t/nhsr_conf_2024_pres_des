...
## Exploring Variation with Pathway Simulation
...
On HSMA, we teach a couple of different modelling and simulation techniques.
...
What we want to tackle our queuing problems in healthcare is **Discrete Event Simulation (DES)**<br/>
...
There is inherently randomness in our healthcare systems that DES can also cope really well with.

:::{.incremental}
- People (entities) don't turn up at a completely predictable rate
...
- With ever-growing awareness and resources, it's a great time to get started
